...
public class AuthorizationServerConfig
    ...
    @Value("${forshare.keyStore}")
    private String keyStore;

    @Value("${forshare.keyPass}")
    private String keyPass;

    @Value("${forshare.keyAlias}")
    private String keyAlias;

    @Value("${forshare.accessTokenValiditySeconds}")
    private int accessTokenValiditySeconds;

    @Value("${forshare.refreshTokenValiditySeconds}")
    ...
    public void configure(ClientDetailsServiceConfigurer clients)
	    throws Exception {
	clients.inMemory().withClient("forshare-app")
